...
\toappear{This work is licensed under the Creative Commons Attribution 4.0 International License. To view a copy of this license, visit {\url{http://creativecommons.org/licenses/by/4.0/}} or send a letter to Creative Commons, PO Box 1866, Mountain View, CA 94042, USA.} 
...
\def\plaintitle{CSE 520 Project Report: Microlearning to Increase Awareness of Computational Concepts}
\def\plainauthor{Emilia Gan, Laura Vonessen}
\def\emptyauthor{}
\def\plainkeywords{computer literacy; computer science education; computer science principles; computational thinking; digital literacy; microlearning}
...
\numberofauthors{3}
\author{%
  \alignauthor{Emilia Gan\\
    \affaddr{University of Washington}\\
    \affaddr{Seattle, USA}\\
    \email{efgan@cs.washington.edu}}\\
  \alignauthor{Laura Vonessen\\
    \affaddr{University of Washington}\\
    \affaddr{Seattle, USA}\\
    \email{laurav4@cs.washington.edu}}\\
}
...
No one can deny the influence computers have on our daily lives. In fact, it is 
difficult to think of any human endeavor that has not been affected by computers. 
Given the importance of computing to all aspects of contemporary life, it seems
only reasonable to expect a minimal level of universal understanding among the 
general population of how computers work and how computers impact them personally. 
However, many who are not directly involved in the technology sector lack computational 
knowledge essential to full participation in today's digital society. Furthermore,
there are many obstacles to gaining computational skills. The effort required to become 
expert, or even proficient, can seem overwhelming. We propose introducing online learning
opportunities of short duration into activities people are already engaging in online. 
These microlearning interactions could serve to increase awareness of important concepts and 
issues pertaining to computer science. In addition, this increased awareness could help 
motivate learners to engage in more in-depth study of topics that grab their interest. In this 
paper, we will investigate the motivating factors, content, and format types that could be
employed in designing such microlearning activities.
...
Principles course launched in Fall, 2016. In collaboration with ******, the following 
seven principles were identified as being central to *****
...
competencies grouped together as computational thinking skills. Building off Jeannette Wing's
writings on the subject, we have included the following areas for consideration as well:

\begin{itemize}
\item Problem Solving
\item Models and Simulations
\item Heuristics
\item Recursive Thinking
\item Redundancy, Backups, and Error Correction
\item Connections Outside Computer Science
\end{itemize}
...
People learn best when they are motivated to do so. Given that these microlearning activities will
be presented to the learner without their active participation in the selection of the activities, the
question of why a person might want to engage in this educational effort needs to be addressed. How can the 
material presented be made engaging and memorable enough to justify interrupting the user's current
activity? Can these activities be introduced without causing frustration detrimental to the learning process?
